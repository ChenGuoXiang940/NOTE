...
def main():
    ...
    t=time.time()
    time.sleep(1)
    print("Bubble Sort: ", bubble_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Selection Sort: ", selection_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Insertion Sort: ", insertion_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Shell Sort: ", shell_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Merge Sort: ", merge_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Quick Sort: ",quick_sort(copy.deepcopy(arr), 0, len(arr)-1),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Heap Sort: ",heap_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Counting Sort: ", counting_sort(copy.deepcopy(arr), max(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Bucket Sort: ", bucket_sort(copy.deepcopy(arr)),round(time.time()-t-1,5))
    t=time.time()
    time.sleep(1)
    print("Radix Sort: ",radixsort(copy.deepcopy(arr)),round(time.time()-t-1,5))
